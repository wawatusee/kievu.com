...
- [ ] **`inc/head.php`** — mini-contrôleur JS par page (symétrique au CSS)
- [ ] **`inc/footer.php`** — à revoir (placement du `RS_menu` ?)
- [ ] **Logo** — créer `public/img/deco/logo.svg`

### Moyen terme — contenu

- [ ] **Balises OG** — alimentées depuis le JSON de la page ou de l'article courant
- [ ] **`src/core/page_renderer.php`** — auditer et documenter
- [ ] **`src/core/article_renderer.php`** — auditer et documenter
- [ ] **`src/core/block_registry.php`** — auditer et documenter
...
*Dernière mise à jour : session 2 — 2026-05-03*  
*Prochaine session : reprendre à `inc/head.php` — mini-contrôleur JS par page.*
